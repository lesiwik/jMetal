...
public class IterationSlider {
    ...
    private List<BaseEMAS> currentIterationEmas;
    ...
    public IterationSlider(Iterable<Algorithm> algorithmsToShow) {
        ...
        algorithmsToShow.forEach(algorithm -> currentIterationEmas.add((BaseEMAS) algorithm));
        initComponents();
...
//        displayButton.setEnabled(false);
    ...
    private void serializeIterations() {
        ...
        for (BaseEMAS baseEMAS : currentIterationEmas) {
            try {
                baseEMAS.serializeGenotype(startingIteration, prevIterationsToSave);
            } catch (Exception e) {
